...
# valid UTF8.
#
# This script should be invoked from the root folder of the candi repository:
...
filenames = itertools.chain(filename_generator(".package"),
                            filename_generator(".platform"),
                            filename_generator(".sh"),
                            filename_generator(".cfg"))
